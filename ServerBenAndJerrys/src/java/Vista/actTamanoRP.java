 ...
 * @author Emiliano
 */
public class actTamanoRP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                Tamano objTam = acc.recogerTamano(id);

                if(objTam!=null){

                        response.sendRedirect("cTamanos.jsp?act=true&nom="+objTam.getTam()+"&id="+objTam.getId_tam());
