...
public class actualizarCantidad extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Cantidad busc = acc.repetidosCantidades(val,u);
                ...
                if(busc==null){
                    ...
                    objCant.setId_cant(Integer.parseInt(id));
                    objCant.setValor(Integer.parseInt(val));
                    objCant.setUnidad(u);

                    int estatus = AccionesAdmin.actualizarCantidad(objCant);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(actualizarCantidad.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
